# =============================================================================
# Script: 03_hypothesis_1_16S_shared_asvs.R
...
#
# Description:
# This script evaluates Hypothesis 1 for bacterial communities:
...
#
# Output files:
#   - written to the folder "results_16S_hyp1"
# =============================================================================
...
# Ensure mapping matches phyloseq sample order
...
write.csv(orchard_summary_df, file.path(outdir, "orchard_summary_16S.csv"), row.names = FALSE)
write.csv(forest_summary_df,  file.path(outdir, "forest_summary_16S.csv"), row.names = FALSE)
...
write.csv(as.data.frame(loo_comp), file.path(outdir, "loo_compare_table.csv"))
...
saveRDS(orchard_summary_df,  file.path(outdir, "orchard_summary_16S.rds"))
saveRDS(forest_summary_df,   file.path(outdir, "forest_summary_16S.rds"))

writeLines(capture.output(sessionInfo()), file.path(outdir, "sessionInfo_16S_hyp1.txt"))
